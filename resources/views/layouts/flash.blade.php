...
@if ($message = Session::get('success'))
    ...
    <div id="box"
        class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800 absolute top-5 right-5">
...
@if ($message = Session::get('danger'))
    ...
    <div id="box"
        ...
        <div class="px-4 py-2 -mx-3">
            <div class="mx-3" onclick="hidden">
                <span class="font-semibold text-red-500 dark:text-red-300">Danger</span>
                <p class="text-sm text-gray-600 dark:text-gray-200">{{ $message }}</p>
            </div>
        </div>
    </div>
...
@if ($errors->any())
    ...
    <div id="box" class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800 absolute top-5 right-5">
        <div class="flex items-center justify-center w-12 bg-red-500">
            <svg class="w-6 h-6 text-white fill-current" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
                <path
