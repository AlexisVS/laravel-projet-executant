<aside x-data="{ open: false }" class="bg-white border-gray-100 border-r-2">
  <nav class="sticky top-0 bg-white border-gray-100 border-r-2">
        ...
        <div class="flex flex-col w-full px-2">
          ...
          <div class="hidden sm:flex sm:items-center mt-4">
            <x-dropdown align="middle right" width="48">
              <x-slot name="trigger">
                <button
                  class="flex ml-1 mb-5 items-center text-lg font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
          ...
          <div class="hidden w-full flex-col space-y-4 sm:flex">
            ...
            <x-nav-link href="/dashboard/livewire-image"
              :active="url()->current() == url('/dashboard/livewire-image')  ">
              {{ __('Livewire Images') }}
            </x-nav-link>
            <x-nav-link href="/dashboard/blog" :active="url()->current() == url('/dashboard/blog')  ">
              {{ __('Blog') }}
            </x-nav-link>
          </div>
        </div>
