                ...
                <tbody>
                  @foreach ($users as $user)
                    <tr class="hover:bg-gray-200">
                      ...
                      <td class="px-5 py-5 border-b border-gray-200 bg-transparent text-sm">
                        <div class="flex items-center">
                          <div class="flex-shrink-0">
                            <img alt="profil" src="{{ asset('storage/img/' . $user->avatars->fileName) }}"
                      ...
                      <td class="px-5 py-5 border-b border-gray-200 bg-transparent text-sm">
                        <span
                          class="relative inline-block px-3 py-1 font-semibold {{ $user->roles->id == 1 ? 'text-red-600' : 'text-green-600' }} leading-tight">
                          <span aria-hidden="true"
                            class="absolute inset-0 {{ $user->roles->id == 1 ? 'bg-red-200' : 'bg-green-200' }} opacity-50 rounded-full">
                          </span>
                          <span class="relative">
                            {{ $user->roles->name }}
                          </span>
